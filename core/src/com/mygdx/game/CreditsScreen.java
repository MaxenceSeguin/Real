...
public class CreditsScreen implements Screen, InputProcessor {
    ...
    private Image background, optionButton, playButton, credits, gmOff, gmOn, back, quit, seOff, seOn, optionBackground, creditsList;
    private GameSettings settings;

    public CreditsScreen(Game aGame, GameSettings settings) {
        ...
        creditsList = new Image(new Texture(Gdx.files.internal("Credits.png")));
