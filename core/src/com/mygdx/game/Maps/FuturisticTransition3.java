...
import com.mygdx.game.Beginning;
import com.mygdx.game.Ending;
...
import com.mygdx.game.Maps.DungeonBridge;
import com.mygdx.game.Maps.JungleBridge;
import com.mygdx.game.TiledMapPlus;

public class FuturisticTransition3 implements InputProcessor, Screen {
    ...
    public FuturisticTransition3(Game aGame, GameSettings settings) {
        this.settings = settings;

        game = aGame;

        tiledMap = new TiledMapPlus("Futuristic_maps/future_glitchedcorridor.tmx", null);
    ...
    public void render(float delta) {
        ...
        camera.showDialog("Dialog/GlitchRoomDialog.png", sb);
