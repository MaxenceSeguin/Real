...
public class FuturisticFinal implements InputProcessor, Screen {
    ...
    public FuturisticFinal(Game aGame, GameSettings settings) {
        this.settings = settings;

        game = aGame;

        tiledMap = new TiledMapPlus("Futuristic_maps/future_final.tmx", null);
    ...
    public void render(float delta) {
        ...
        camera.showDialog("Dialog/LastRoomHint.png", sb);
