...
public class JungleTransition3 implements InputProcessor, Screen {
    ...
    public JungleTransition3(Game aGame, GameSettings settings) {
        this.settings = settings;

        game = aGame;

        tiledMap = new TiledMapPlus("jungle_corridor3.tmx", null);
